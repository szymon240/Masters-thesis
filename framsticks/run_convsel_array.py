...
from convsel_frams import run_convsel
...
RESULTS_DIR = Path("convsel_grid_results_v2")
CHECKPOINT_DIR = Path("convsel_checkpoints_v2")
...
def main():
    ...
    # Seedy: paczka 10 unikalnych dla kazdej kombinacji, offset algorytmu = 100000 (CS)
    # Zakres: 100000 .. 102159 (216 kombinacji x 10 runow). Brak nakladek z innymi algorytmami.
    base_seed = 100000 + (args.array_id * NUMBER_OF_RUNS)
    ...
    for run_id in range(NUMBER_OF_RUNS):
        ...
        try:
            run_t0 = time.time()
            history, best_geno = run_convsel(params, EVALUATIONS_BUDGET, frams_evaluate, global_framsLib)
