...
from hybrid_frams import run_hybrid
...
CHECKPOINT_DIR = Path("hybrid_checkpoints_v2")
...
def main():
    ...
    for run_id in range(NUMBER_OF_RUNS):
        ...
        try:
            ...
            # Zapobiega akumulacji ogromnych plikow checkpoint (np. 9.6GB dla pop=1000).
